...
import com.example.nfc.view.route.RouteRegister
...
fun NavigationGraph(loginViewModel: LoginViewModel,
    ...
    NavHost(
        ...
        composable(route = Screen.Login.route) {
            RouteLogIn(onLoginClick = {
                navHostController.navigate(Screen.Home.route)
            }, registerClick = {
                navHostController.navigate(Screen.Register.route)
            }, loginViewModel = loginViewModel, onForgetPasswordClick = {
        ...
        composable(route = Screen.Home.route) {
            RouteHome(
                ...
                onFAQClick = {
                    navHostController.navigate(Screen.FAQ.route)
                },
                onAboutClick = {
                    navHostController.navigate(Screen.About.route)
                },
                onDeleteAccountClick = {
                    navHostController.navigate(Screen.Delete.route)
                },

                )
        }
        composable(route = Screen.Profile.route) {
            RouteProfile(accountViewModel = accountViewModel, onSignOutClicked = {
                navHostController.navigate(Screen.Login.route)
            }, onBackClick = {
                navHostController.navigate(Screen.Home.route)
            })
        ...
        composable(route = Screen.ForgetPassword.route) {
            RouteForgetPassword(forgetPasswordViewModel = forgetPasswordViewModel,
                onItsDoneClick = {
                    navHostController.navigate(Screen.Login.route)
                },
                onBackClick = {
        ...
        composable(route = Screen.FAQ.route) {
            RouteFAQ(faqViewModel = faqViewModel, onBackClick = {
                navHostController.navigate(Screen.Home.route)
            })
        }
        composable(route = Screen.About.route) {
            RouteAbout(aboutInfoViewModel = aboutInfoViewModel, onBackClick = {
                navHostController.navigate(Screen.Home.route)
            })
        }
        composable(route = Screen.Delete.route) {
            RouteDeleteAccount(deleteAccountViewModel = deleteAccountViewModel, onDeleteClick = {
                navHostController.navigate(Screen.Login.route)
            }, onBackClick = {
                navHostController.navigate(Screen.Home.route)
            })
